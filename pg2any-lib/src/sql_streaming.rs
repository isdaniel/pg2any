...
impl SqlStreamParser {
    ...
    pub async fn parse_file_from_index_collect(
        ...
        self.parse_stream_collect(reader, start_index, cancellation_token)
            .await
    }
...
mod tests {
    ...
    async fn test_simple_statements() {
        ...
        let statements = parser
            .parse_file_from_index_collect(Path::new(&file_path), 0, &cancel_token)
            .await
            .unwrap();
    ...
    async fn test_cancellation() {
        ...
        // Should process no statements due to immediate cancellation
