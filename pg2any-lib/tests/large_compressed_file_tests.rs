...
async fn test_large_compressed_file_streaming_decompression() {
    ...
    // Manually decompress and parse to verify the fix
    // This tests the core functionality without needing TransactionFileManager internals
    ...
    use pg2any_lib::sql_streaming::SqlStreamParser;
...
async fn test_graceful_cancellation_during_decompression() {
    ...
    // Test with streaming decompression
    use async_compression::tokio::bufread::GzipDecoder;
    use pg2any_lib::sql_streaming::SqlStreamParser;
    use tokio::io::BufReader;
    use tokio_util::sync::CancellationToken;
